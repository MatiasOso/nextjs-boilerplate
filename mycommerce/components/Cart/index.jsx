...
export default function Cart() {
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={ ()=> dispatch(toggleCart())}>
        <Transition.Child
          as={Fragment}
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-morado shadow-xl ">  {/* AQUIii  */}
                    ...
                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6 bg-crema">
                      ...
                      <div className="mt-6" >
                        <a
                          href="#"
                          className="flex items-center justify-center rounded-md border border-transparent bg-morado px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
                        >
                          Finalizar compra
                        </a>
                      </div>
